...
const statusFilter = ["", "Хүлээгдэж буй", "Баталсан", "Цуцалсан", "Шаардлага хангаагүй"] as const;
                            ...
                            <tr key={`${name}-${f.id}`} className="hover:bg-gray-50">
                              ...
                              <td className="px-4 py-2 text-sm">
                                <button
                                  ...
                                  className="px-3 py-1.5 rounded-lg border text-blue-600 border-blue-200 hover:bg-blue-50"
                                >
                                  View
                                </button>
                              </td>
